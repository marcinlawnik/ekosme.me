...
@section('content')
    ...
    <div class="container">
        ...
        <ul>
            ...
            <li>Każda talia może zawierać maksymalnie:<br/>
                <ul>
        ...
        <ul>
            ...
            <li>Mecze można rozgrywać na dowolnym urządzeniu obsugujący klienta gry <a href="https://eu.battle.net/account/download/?show=hearthstone&style=hearthstone">Herathstone: Heroes of Warcraft</a>.</li>
